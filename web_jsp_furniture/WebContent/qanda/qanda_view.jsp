	...
	<% } %>
		...
		<div id="b_right">
			...
			<table class="boardForm">
				...
				<tbody>
					...
					<tr>
						<th>Content</th>
						<td colspan="3">
							<textarea name="t_q_content" class="textArea_H250_noBorder" readonly><%=dto.getQ_content() %></textarea>
						</td>
					</tr>	
					<tr>
						<th>Writer</th>
					...
					<tr>
						<th>content</th>
						<td colspan="3">
							<textarea name="t_a_content" class="textArea_H250_noBorder" readonly><%=dto.getA_content() %></textarea>	
						</td>
					</tr>	
						<tr>
							<th>Writer</th>
			...
			<div class="buttonGroup">
				...
				<% if(dto.getA_reg_id() == null){%>
				<a href="qanda_a_update.jsp?t_no=<%=dto.getNo()%>" class="butt">답글 작성</a>
				<% }else{%>
